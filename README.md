...
| L2 fee (ETH)    |   `0.000003433` | `0.000001320` | `0.000001185` | `0.000001742` | `0.000001242` |         `0.000001272` |
| L1 gas used     |          `8076` |        `9256` |        `9516` |       `11596` |        `7832` |                `9012` |
| L1 fee (ETH)    |   `0.000220959` | `0.000253244` | `0.000260358` | `0.000317267` | `0.000214284` |         `0.000246568` |
| Total fee (ETH) |   `0.000224393` | `0.000254564` | `0.000261543` | `0.000319009` | `0.000215526` |         `0.000247840` |
| Total fee (USD) |         `$0.56` |       `$0.64` |       `$0.65` |       `$0.80` |       `$0.54` |               `$0.62` |
...
| L2 fee (ETH)    |   `0.000000660` | `0.000000648` | `0.000000654` | `0.000000706` | `0.000000612` |         `0.000000627` |
| L1 gas used     |          `7292` |        `7904` |        `7408` |        `7504` |        `7292` |                `7852` |
| L1 fee (ETH)    |   `0.000199509` | `0.000216253` | `0.000202683` | `0.000205309` | `0.000199509` |         `0.000214831` |
| Total fee (ETH) |   `0.000200170` | `0.000216901` | `0.000203336` | `0.000206015` | `0.000200121` |         `0.000215458` |
| Total fee (USD) |         `$0.50` |       `$0.54` |       `$0.51` |       `$0.52` |       `$0.50` |               `$0.54` |
...
| L2 fee (ETH)    |   `0.000000758` | `0.000000743` | `0.000000750` | `0.000000803` | `0.000000708` |         `0.000000724` |
| L1 gas used     |          `7964` |        `8576` |        `8092` |        `8176` |        `7940` |                `8500` |
| L1 fee (ETH)    |   `0.000217895` | `0.000234639` | `0.000221397` | `0.000223695` | `0.000217238` |         `0.000232560` |
| Total fee (ETH) |   `0.000218653` | `0.000235383` | `0.000222148` | `0.000224498` | `0.000217946` |         `0.000233284` |
| Total fee (USD) |         `$0.55` |       `$0.59` |       `$0.56` |       `$0.56` |       `$0.54` |               `$0.58` |
...
| Total fee (USD) |         `$0.78` |       `$0.58` |       `$0.61` | `Unsupported` | `Unsupported` |         `Unsupported` |
...
| Total fee (USD) |         `$0.56` | `Unsupported` |       `$0.68` | `Unsupported` | `Unsupported` |         `Unsupported` |
...
| Total fee (USD) |         `$0.60` |       `$0.78` |       `$0.74` | `Unsupported` | `Unsupported` |         `Unsupported` |
...
| L2 fee (ETH)    |   `0.000002901` | `0.000000790` | `0.000000656` | `0.000001157` | `0.000000741` |         `0.000000762` |
| L1 gas used     |          `2600` |        `3184` |        `3920` |        `5940` |        `2356` |                `2992` |
| L1 fee (ETH)    |   `0.000071136` | `0.000087114` | `0.000107251` | `0.000162518` | `0.000064460` |         `0.000081861` |
| Total fee (ETH) |   `0.000074037` | `0.000087904` | `0.000107907` | `0.000163675` | `0.000065201` |         `0.000082623` |
| Total fee (USD) |         `$0.19` |       `$0.22` |       `$0.27` |       `$0.41` |       `$0.16` |               `$0.21` |
...
| L2 fee (ETH)    |   `0.000000202` |           `-` | `0.000000181` | `0.000000303` | `0.000000158` |         `0.000000159` |
| L1 gas used     |          `2756` |           `-` |        `2900` |        `5012` |        `2744` |                `2756` |
| L1 fee (ETH)    |   `0.000075404` |           `-` | `0.000079344` | `0.000137128` | `0.000075076` |         `0.000075404` |
| Total fee (ETH) |   `0.000075606` |           `-` | `0.000079525` | `0.000137432` | `0.000075233` |         `0.000075563` |
| Total fee (USD) |         `$0.19` | `Unsupported` |       `$0.20` |       `$0.34` |       `$0.19` |               `$0.19` |
...
| L2 fee (ETH)    |   `0.000000299` |           `-` | `0.000000277` | `0.000000399` | `0.000000254` |         `0.000000255` |
| L1 gas used     |          `3420` |           `-` |        `3576` |        `5684` |        `3420` |                `3432` |
| L1 fee (ETH)    |   `0.000093571` |           `-` | `0.000097839` | `0.000155514` | `0.000093571` |         `0.000093900` |
| Total fee (ETH) |   `0.000093870` |           `-` | `0.000098116` | `0.000155913` | `0.000093825` |         `0.000094155` |
| Total fee (USD) |         `$0.23` | `Unsupported` |       `$0.25` |       `$0.39` |       `$0.23` |               `$0.24` |
